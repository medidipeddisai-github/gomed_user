...
import 'package:admin_panel/services/sevices.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                CategoryCard(icon: Icons.medical_services, label: 'Healthcare', screenWidth: screenWidth),
                CategoryCard(icon: Icons.brush, label: 'Beauty', screenWidth: screenWidth),
                CategoryCard(icon: Icons.directions_bike, label: 'Wellness', screenWidth: screenWidth),
              ],
            ),
            SizedBox(height: screenHeight * 0.02),
            const Text(
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  ServiceCard(screenWidth: screenWidth,screenHeight:screenHeight),
                  ServiceCard(screenWidth: screenWidth,screenHeight:screenHeight),
                  ServiceCard(screenWidth: screenWidth,screenHeight:screenHeight),
                  ServiceCard(screenWidth: screenWidth,screenHeight:screenHeight),
                  ServiceCard(screenWidth: screenWidth,screenHeight:screenHeight),
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  ...
                  padding: EdgeInsets.symmetric(
                    vertical: screenHeight * 0.015, horizontal: screenWidth * 0.3),
                ),
                onPressed: () {
                  Navigator.push(
...
class CategoryCard extends StatelessWidget {
  const CategoryCard({super.key, required this.icon, required this.label, required this.screenWidth});
  final IconData icon;
  final String label;
