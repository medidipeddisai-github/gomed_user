...
import 'package:admin_panel/ordertracking.dart';
...
class BookingsPage extends StatelessWidget {
  ...
  Widget _buildBookingCard(BuildContext context, double screenWidth, double screenHeight) {
    return Card(
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => OrderTrackingPage(currentStep: status,),
                      ),
                    );
                  },
