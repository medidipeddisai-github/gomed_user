import 'package:admin_panel/services/service_details.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Service Name',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: widget.screenWidth * 0.045),
          ),
          Text(
            'Category',
            style: TextStyle(color: Colors.blue, fontSize: widget.screenWidth * 0.035),
          ),
          ...
          Row(
            children: [
              Text(
                '₹ 500',
                style: TextStyle(
                    fontWeight: FontWeight.bold, color: Colors.black, fontSize: widget.screenWidth * 0.04),
              ),
              const Spacer(),
              Row(
                children: List.generate(
                  5,
                  (index) => Icon(Icons.star, color: Colors.amber, size: widget.screenWidth * 0.035),
                ),
              ),
            ],
          ),
          ...
          Align(
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (context) => const ServiceDetailsPage()));
              },
              icon: Icon(Icons.arrow_forward, size: widget.screenWidth * 0.04),
              label: Text('Details', style: TextStyle(fontSize: widget.screenWidth * 0.04)),
