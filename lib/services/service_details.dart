import 'package:admin_panel/bookingstagepage.dart';
            ...
            children: [
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                       Navigator.push(
                    context, MaterialPageRoute(builder: (context) => const BookingStagePage()));
                  },
              ...
              Row(
                children: [
                  IconButton(
                    icon: Icon(Icons.facebook, color: Colors.blue, size: screenWidth * 0.07),
                    onPressed: () {},
                  ),
                  IconButton(
                    icon: Icon(FontAwesomeIcons.twitter, color: Colors.lightBlue, size: screenWidth * 0.07),
                    onPressed: () {},
                  ),
                  IconButton(
                    icon: Icon(Icons.linked_camera, color: Colors.red, size: screenWidth * 0.07),
                    onPressed: () {},
                  ),
              ...
              // Review Cards
              ...List.generate(4, (index) => _buildReviewCard(screenWidth, screenHeight)),
            ],
          ),
        ),
      ),
      ...
      child: Row(
        ...
        children: [
          CircleAvatar(
            ...
            backgroundImage: const AssetImage('assets/user_profile.png'), // Replace with actual image
          ),
